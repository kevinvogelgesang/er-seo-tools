    ...
    <div className="space-y-8">
      ...
      <div className="bg-white border border-gray-200 rounded-2xl overflow-hidden shadow-sm">
        <div className="flex items-center gap-3 px-6 py-4 border-b border-gray-100 bg-gray-50">
          ...
          <h2 className="font-display font-bold text-[17px] text-navy">Recent Page Audits</h2>
        </div>
        <div className="p-6">
          <AuditHistory />
        </div>
      ...
      <div className="bg-white border border-gray-200 rounded-2xl overflow-hidden shadow-sm">
        <div className="flex items-center gap-3 px-6 py-4 border-b border-gray-100 bg-gray-50">
          ...
          <h2 className="font-display font-bold text-[17px] text-navy">Recent Site Audits</h2>
        </div>
        <div className="p-6">
          <SiteAuditHistory />
        </div>

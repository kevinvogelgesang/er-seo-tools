...
//
// Renders the technical SEO roadmap (markdown) using react-markdown with custom
// component overrides that mirror MemoMarkdown's typography. We deliberately do
// NOT enable rehype-raw — the roadmap is server-stored markdown that we trust as
// text, and disabling raw HTML keeps the rendering safe. Do not add `rehype-raw`.

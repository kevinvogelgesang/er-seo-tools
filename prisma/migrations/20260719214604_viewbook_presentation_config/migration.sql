...
CREATE TABLE "new_Viewbook" (
    ...
    "collapseAffordance" TEXT NOT NULL DEFAULT 'bar',
...
INSERT INTO "new_Viewbook" ("clientId", "clientNotifyJson", "createdAt", "createdBy", "csmName", "dataLockedAt", "dataLockedBy", "digestCursorId", "digestSentAt", "id", "kind", "notifyEmail", "pcCompletedAt", "revokedAt", "stage", "syncVersion", "themeJson", "token", "updatedAt", "welcomeNote") SELECT "clientId", "clientNotifyJson", "createdAt", "createdBy", "csmName", "dataLockedAt", "dataLockedBy", "digestCursorId", "digestSentAt", "id", "kind", "notifyEmail", "pcCompletedAt", "revokedAt", "stage", "syncVersion", "themeJson", "token", "updatedAt", "welcomeNote" FROM "Viewbook";
DROP TABLE "Viewbook";
